        ...
        {FIGMA_ECOSYSTEM.map((channel) => {
          ...
          if (channel.id === 'if_site') {
            ...
            return (
              ...
              >
                <div className="w-11 h-11 rounded-full overflow-hidden shrink-0 bg-[#161616] dark:bg-white flex items-center justify-center p-2.5">
                  <img
                    src={channel.avatar}
                    alt={channel.title}
              ...
              <div className="flex items-center gap-1 overflow-x-auto no-scrollbar pt-0.5">
                {channel.links.map((link) => (
                  <button
                    ...
                    className="text-[#161616] bg-white hover:bg-neutral-100 transition-colors shadow-2xs shrink-0 cursor-pointer flex items-center gap-1"
                  >
